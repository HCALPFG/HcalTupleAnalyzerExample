...
// Thu Jun 29 16:59:34 2017 by ROOT version 6.08/07
// from TTree tree/
// found on file: root://cmseos.fnal.gov//store/user/abuccill/hcal-analysis/hf_phase_settings_2017/hcal_pfg_ZeroBias_Run2017A-v1_RAW_fill_5822_merged.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmseos.fnal.gov//store/user/abuccill/hcal-analysis/hf_phase_settings_2017/hcal_pfg_ZeroBias_Run2017A-v1_RAW_fill_5822_merged.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmseos.fnal.gov//store/user/abuccill/hcal-analysis/hf_phase_settings_2017/hcal_pfg_ZeroBias_Run2017A-v1_RAW_fill_5822_merged.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://cmseos.fnal.gov//store/user/abuccill/hcal-analysis/hf_phase_settings_2017/hcal_pfg_ZeroBias_Run2017A-v1_RAW_fill_5822_merged.root:/hcalTupleTree");
